                        ...
                        <form action="{{ route('profiles.update', $profile->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" value="М" id="genderM" {{ $profile->gender === 'М' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="genderM" {{ $profile->gender === 'М' ? 'checked' : '' }}>М</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" value="Ж" id="genderW">
                                    <label class="form-check-label" for="genderW" {{ $profile->gender === 'Ж' ? 'checked' : '' }}>Ж</label>
                                </div>
                            </div>
